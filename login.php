...
<div class="max-w-md mx-auto">
    <h2 class="text-3xl text-center font-semibold mb-6 mt-4">Login</h2>
<?php
    session_start();
    ...
    <form method="post" action="process_login.php">
        ...
        <div class="mb-4 flex">
            <label class="cursor-pointer label">
                <input type="checkbox" checked="checked" name="remember_me" class="checkbox checkbox-info" />
        ...
        <div class="mb-4 text-center">
            <p>Not having an account? Register <a href="register.php" class="link link-info">here</a>.</p>
        </div>
    </form>
</div>
</body>
